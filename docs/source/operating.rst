[finalproject-1498] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [finalproject-1498] container is NOT running**.

.. tip::
   You must have your [finalproject-1498] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/143604205-myseneca/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/143604205-myseneca/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=32913  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='143604205-myseneca'  \-\-env DOCKERUSERNAME='skandhare@myseneca.ca'  \-\-env MQTTUSERNAME='143604205-myseneca'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   skandhare@myseneca.ca/finalproject-1498-amd64 (https://hub.docker.com/r/skandhare@myseneca.ca/finalproject-1498-amd64)
...
.. code-block::
   ...
   docker run -d -p 53803:53803 -p 60679:60679 -p 33247:33247 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=finalproject-1498 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-finalproject-1498 \
          --env GITUSERNAME=143604205-myseneca \
          --env GITREPOURL=https://github.com/143604205-myseneca/raspberrypi \
          --env SOLUTIONEXTERNALPORT=53803 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=60679  \
          --env SOLUTIONVIPERVIZPORT=33247 \
          --env DOCKERUSERNAME='skandhare@myseneca.ca' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=32913 \
          --env KAFKACLOUDUSERNAME='' \
          --env VIPERVIZPORT=9005 \
          --env MQTTUSERNAME='143604205-myseneca' \
          --env AIRFLOWPORT=9000  \
          --env GITPASSWORD='<Enter Github Password>' \
          --env KAFKACLOUDPASSWORD='<Enter API secret>' \
          --env MQTTPASSWORD='<Enter mqtt password>' \
          --env READTHEDOCS='<Enter Readthedocs token>' \
          skandhare@myseneca.ca/finalproject-1498-amd64
...
[finalproject-1498] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/143604205-myseneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/finalproject-1498
...
.. important::
   https://finalproject-1498.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-finalproject-1498
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=53803, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45093, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41541, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=44987, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=39753, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40541, HPDEHOST=127.0.1.1, HPDEPORT=40827, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45907

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3024-finalproject-1498,solution_preprocessing_ai_mqtt_dag-finalproject-1498, python-preprocess-930-finalproject-1498,solution_preprocessing_ai_mqtt_dag-finalproject-1498, python-ai-3506-finalproject-1498,solution_preprocessing_ai_mqtt_dag-finalproject-1498, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
